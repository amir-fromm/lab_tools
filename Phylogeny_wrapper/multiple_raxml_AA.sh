...
do 
    ...
    bsub -q new-short  -J log/raxml$file.%J -o log/raxml$file.%J.o -e log/raxml$file.%J.e  -R "rusage[mem=$MEM]" -n 2 raxmlHPC -f a -p 12345 -s $file -x 12356 -# 100 -m PROTGAMMAILGX -w $pwd/output -n $outfile.txt
    sleep 2 
done
